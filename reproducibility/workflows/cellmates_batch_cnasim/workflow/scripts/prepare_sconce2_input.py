...
def prepare_bed_files(adata_path, normal_bed_dir, tumor_bed_dir, normal_obs_name):
...
def main():
    ...
    prepare_bed_files(args.input, normal_bed_dir, tumor_bed_dir, args.normal_obs_name)
